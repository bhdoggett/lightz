...
| Download                                                                                                      | For                         |
| ------------------------------------------------------------------------------------------------------------- | --------------------------- |
| [Lightz-0.2.9-arm64.dmg](https://github.com/bhdoggett/lightz/releases/download/v0.2.9/Lightz-0.2.9-arm64.dmg) | Apple Silicon (M1 and later) |
| [Lightz-0.2.9.dmg](https://github.com/bhdoggett/lightz/releases/download/v0.2.9/Lightz-0.2.9.dmg)             | Intel Mac                   |
